              ...
              <div className="content">
                  <div className="handling">
                      ...
                      <div className="handling-shuffle" title="Shuffle">
                          <svg  fill="none"  className="icon-shuffle"  stroke-linecap="round" stroke-linejoin="round" stroke-width="2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" id="shuffle">
                             ...
                             <div className="controls-buttons">
                                 ...
                                 <div className="controls-button controls-play">
                                     <svg className="icon-pause">
                                         <path d="M20 36.6667C29.2047 36.6667 36.6666 29.2047 36.6666 20C36.6666 10.7953 29.2047 3.33333 20 3.33333C10.7952 3.33333 3.33331 10.7953 3.33331 20C3.33331 29.2047 10.7952 36.6667 20 36.6667Z" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                                         <path d="M16.6667 25V15" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                                         <path d="M23.3333 25V15" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                                     </svg>
                      ...
                      <div className="items">
                          <div className="item">
                              ...
                              <div className="item-titles">
                                  <h2 className="item-group">Rammstein</h2>
                                  <h3 className="item-track">Rammstein</h3>
                              </div>
                              <p className="item-duration">03:45</p>
